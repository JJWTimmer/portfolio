export type Layer = "tech" | "platform" | "skill"

export type Skill = {
    name: string
    level: "Expert" | "Advanced" | "Intermediate" | "inUse"
    years: number
    layer: Layer
...
export const LAYERS: Record<Layer, { label: string; text: string; bg: string; border: string }> = {
    tech: {label: "Build it", text: "text-amber-400", bg: "bg-amber-400", border: "border-amber-400"},
    platform: {label: "Run it", text: "text-sky-400", bg: "bg-sky-400", border: "border-sky-400"},
    skill: {label: "Concepts", text: "text-emerald-400", bg: "bg-emerald-400", border: "border-emerald-400"},
}
...
export const LEVELS = {
    ...
    Advanced: {
        filled: 2,
        definition: "Trust myself with it in prod. Know where it bites.",
    },
    Intermediate: {
        filled: 1,
        definition: "Get stuff done. Still google things.",
    },
    inUse: {
        filled: 0,
        definition: "Touch it regularly, haven't rated myself. Ask if you're curious.",
    },
} as const

export const skills: Skill[] = [
    {name: "Java && Maven", level: "Expert", years: 13, layer: "tech", featured: true},
    {name: "Quarkus", level: "Expert", years: 2, layer: "tech"},
    {name: "Spring Boot", level: "Expert", years: 8, layer: "tech"},
    {name: "Git", level: "Expert", years: 12, layer: "tech"},
    {name: "Python", level: "Advanced", years: 8, layer: "tech"},
    {name: "Javascript/Typescript && NodeJS", level: "Advanced", years: 5, layer: "tech"},
    {name: "PostgreSQL && PostGIS", level: "Advanced", years: 10, layer: "tech"},
    {name: "MongoDB", level: "Advanced", years: 5, layer: "tech"},
    {name: "Camunda", level: "Advanced", years: 5, layer: "tech"},
    {name: "Scala && sbt", level: "Intermediate", years: 3, layer: "tech"},

    {name: "Linux", level: "Expert", years: 13, layer: "platform"},
    {name: "Gitlab CI || Github Actions", level: "Expert", years: 10, layer: "platform"},
    {name: "AWS", level: "Advanced", years: 7, layer: "platform"},
    {name: "Cloudflare", level: "Advanced", years: 5, layer: "platform"},
    {name: "Kubernetes && OpenShift", level: "Advanced", years: 6, layer: "platform", featured: true},
    {name: "Hypervisors && VPS", level: "Advanced", years: 8, layer: "platform"},
    {name: "Docker && Podman", level: "Advanced", years: 8, layer: "platform"},
    {name: "Ansible", level: "Advanced", years: 6, layer: "platform"},
    {name: "Azure", level: "Intermediate", years: 3, layer: "platform"},
    {name: "Terraform", level: "Intermediate", years: 4, layer: "platform"},

    {name: "Agile && Scrum", level: "Expert", years: 13, layer: "skill", featured: true},
    {name: "CI/CD", level: "Expert", years: 13, layer: "skill"},
    {name: "DevOps", level: "Expert", years: 13, layer: "skill"},
    {name: "Cloud", level: "Expert", years: 13, layer: "skill"},
